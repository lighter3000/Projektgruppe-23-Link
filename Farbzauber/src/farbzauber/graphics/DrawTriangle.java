...
public class DrawTriangle extends JLabel{
	...
	public String [] inoutValueToValues(String value) {
		...
		copyValue = copyValue.replace("dtriangle: ","");
	...
	public String toString(){		
		return " Draw_Triangle: "+"x1("+getX1Position()+"), "+"y1("+getY1Position()+"), "+"x2("+getX2Position()+"), "+"y2("+getY2Position()+"), "+"x3("+getX3Position()+"), "+"y3("+getY3Position()+")";
	}
}
