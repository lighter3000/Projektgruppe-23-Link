...
func _on_start_block_startblock_clicked(node):
	if first_clicked == null:
		...
		elif first_clicked.is_in_group("finish_block"):
			emit_signal("connection_to_finish_block", node)
		first_clicked = null
...
func _on_while_block_while_block_clicked(node):
	if first_clicked == null:
		...
		emit_signal("connection_to_while_block", first_clicked)
		if first_clicked.is_in_group("if_block"):
			emit_signal("connection_to_if_block", node)
		elif first_clicked.is_in_group("while_block"):
			emit_signal("connection_to_while_block", node)
...
func _on_finish_block_finish_block_clicked(node):
	if first_clicked == null:
		...
		emit_signal("connection_to_finish_block", first_clicked)
		if first_clicked.is_in_group("if_block"):
			emit_signal("connection_to_if_block", node)
		elif first_clicked.is_in_group("while_block"):
			emit_signal("connection_to_while_block", node)
