...
public class DrawTriangle extends JLabel{
	...
	public DrawTriangle(int x1Position, int y1Position,
	...
	public DrawTriangle(int [] xPositions, int [] yPositions, Color color, int lineWidth){
	...
	public DrawTriangle(String drawTriangle){
	...
	public String [] inoutValueToValues(String value) {
		...
		copyValue = copyValue.replace("triangle: ","");
	...
	public void paintComponent(Graphics g) {
		...
		if(getPanelCenter().centerbool == true) {
			if (getPanelCenter().centerzoomlevel == 1) {
				getGraphics2D().drawPolygon(getXPoints(), getYPoints(), 3);
	...
	public String toString(){		
		return "Triangle: "+"x1("+getX1Position()+"), "+"y1("+getY1Position()+"), "+"x2("+getX2Position()+"), "+"y2("+getY2Position()+"), "+"x3("+getX3Position()+"), "+"y3("+getY3Position()+")";
	}
}
