...
public class DrawRectangle extends JLabel{
	...
	public DrawRectangle(int xPosition, int yPosition, int width, int height, Color color, int lineWidth){
	...
	public DrawRectangle(String drawRectangle){
	...
	public void setDrawRectangleValues(int xPosition, int yPosition, int width, int height, Color color, int lineWidth){
		this.setXPosition(xPosition);
		this.setYPosition(yPosition);
	...
	public String [] inoutValueToValues(String value) {
		...
		copyValue = copyValue.replace("rectangle: ","");
	...
	public void paintComponent(Graphics g) {
		...
		if(getPanelCenter().centerbool == true) {
			if (getPanelCenter().centerzoomlevel == 1) {			
				getGraphics2D().drawRect(getXPosition(), getYPosition(), getHorizontalSize(), getVerticalSize()); 
	...
	public String toString(){		
		return "Rectangle: "+"x("+getXPosition()+"), "+"y("+getYPosition()+"), "+"Breite("+getHorizontalSize()+"), "+"Hoehe("+getVerticalSize()+")";
	}
}
