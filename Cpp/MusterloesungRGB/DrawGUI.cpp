...
//----------------------------------------------------------------------------------------
//Draw_Triangle
void setDrawTriangle(int x1P, int y1P, int x2P, int y2P, int x3P, int y3P,
             int red,int green,int blue,
             int lineWidth)//
{
    string strTriangle= "";
    ...
    strTriangle = "dtriangle: x1(" + strX1P + "), y1(" + strY1P + "), x2(" + strX2P + "), y2(" + strY2P + "), x3(" + strX3P + "), y3(" + strY3P + "), red(" + strRed + "), green(" + strGreen + "), blue(" + strBlue + "), lineWidth(" + strLineWidth +")";
...
//----------------------------------------------------------------------------------------
//Fill_Triangle
void setFillTriangle(int x1P, int y1P, int x2P, int y2P, int x3P, int y3P,
             int red,int green,int blue,
             int lineWidth)//
{
    string strTriangle= "";
    ...
    strTriangle = "ftriangle: x1(" + strX1P + "), y1(" + strY1P + "), x2(" + strX2P + "), y2(" + strY2P + "), x3(" + strX3P + "), y3(" + strY3P + "), red(" + strRed + "), green(" + strGreen + "), blue(" + strBlue + "), lineWidth(" + strLineWidth +")";
...
//----------------------------------------------------------------------------------------
//Draw_Rectangle
void setDrawRectangle(int xP, int yP, int width, int height,
                  int red,int green,int blue,
                  int lineWidth)//
{
    string strRectangle= "";
    ...
    strRectangle = "drectangle: x(" + strXP + "), y(" + strYP + "), width(" + strWidth + "), height(" + strHeight + "), red(" + strRed + "), green(" + strGreen + "), blue(" + strBlue + "), lineWidth(" + strLineWidth +")";
...
//----------------------------------------------------------------------------------------
//Fill_Rectangle
void setFillRectangle(int xP, int yP, int width, int height,
                  int red,int green,int blue,
                  int lineWidth)//
{
    string strRectangle= "";
    ...
    strRectangle = "frectangle: x(" + strXP + "), y(" + strYP + "), width(" + strWidth + "), height(" + strHeight + "), red(" + strRed + "), green(" + strGreen + "), blue(" + strBlue + "), lineWidth(" + strLineWidth +")";
...
//----------------------------------------------------------------------------------------
//Circle
void setDrawCircle(int xP, int yP, int radius,
                  int red,int green,int blue,
                  int lineWidth)//
{
    string strCircle= "";
    ...
    strCircle = "dcircle: x(" + strXP + "), y(" + strYP + "), radius(" + strRadius + "), red(" + strRed + "), green(" + strGreen + "), blue(" + strBlue + "), lineWidth(" + strLineWidth +")";
...
//----------------------------------------------------------------------------------------
//Fill Circle
void setFillCircle(int xP, int yP, int radius,
                  int red,int green,int blue,
                  int lineWidth)//
{
    string strCircle= "";
    ...
    strCircle = "fcircle: x(" + strXP + "), y(" + strYP + "), radius(" + strRadius + "), red(" + strRed + "), green(" + strGreen + "), blue(" + strBlue + "), lineWidth(" + strLineWidth +")";
