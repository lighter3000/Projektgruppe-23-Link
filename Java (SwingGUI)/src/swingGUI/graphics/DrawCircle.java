...
public class DrawCircle extends JLabel{
	...
	public DrawCircle(int xPosition, int yPosition, int radius, Color color, int lineWidth){
	...
	public DrawCircle(String drawCircle){
	...
	public void setDrawCircleValues(int xPosition, int yPosition, int radius, Color color, int lineWidth){
		this.setXPosition(xPosition);
		this.setYPosition(yPosition);
		this.setRadius(radius);
	...
	public String [] inoutValueToValues(String value) {
		...
		copyValue = copyValue.replace("circle: ","");
	...
	public void paintComponent(Graphics g) {
		...
		if(getPanelCenter().centerbool == true) {
			if (getPanelCenter().centerzoomlevel == 1) {			
				getGraphics2D().drawOval(getXPosition(), getYPosition(), getRadius()*2, getRadius()*2);
	...
	public String toString(){		
		return "Circle: "+"x("+getXPosition()+"), "+"y("+getYPosition()+"), "+"Radius("+getRadius()+")";
	}
